...
const CalculatorUsageGuide = ({ open, onClose }) => {
  return (
    ...
    >
      ...
      <DialogContent>
        <p>
          <strong>Understanding the Home AffordabilityCalculator:</strong>
          <br />
        ...
        <p>
          ...
          <br />
          Financial experts recommend allocating no more than 28% of your monthly income to go towards your monthly home payment costs. 
          To detemine the most optimal solution, we've used the following calculation:
          28% of monthly  income =((Monthly Salary - monthlyDebt) + Downpayment) * .28
